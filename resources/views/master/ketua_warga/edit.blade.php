                        ...
                        <div class="col-md-9">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="rt" class="form-control" id="rt" value="{{ $petugas->rt }}"/>
                                    @if ($errors->has('rt'))
                                        <span class="help-block">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="rw" class="form-control" id="rw" value="{{ $petugas->rw }}" />
                                    @if ($errors->has('rw'))
                                        <span class="help-block">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="masa_bakti_mulai" id="masa_bakti_mulai" class="form-control" value="{{ $petugas->masa_bakti_mulai }}" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="masa_bakti_akhir" id="masa_bakti_akhir" class="form-control" value="{{ $petugas->masa_bakti_akhir }}" />
